...
slug: /instruments/videomancer/vidmusic
title: "Vidmusic"
image: /img/instruments/videomancer/vidmusic/vidmusic_hero_s1.png
...
import vidmusic_control_panel from '/img/instruments/videomancer/vidmusic/vidmusic_control_panel.png';
import vidmusic_source1_sunset from '/img/instruments/videomancer/vidmusic/vidmusic_source1_sunset.png';
import vidmusic_source2_ballerina from '/img/instruments/videomancer/vidmusic/vidmusic_source2_ballerina.png';
import vidmusic_source3_elephant from '/img/instruments/videomancer/vidmusic/vidmusic_source3_elephant.png';
import vidmusic_source4_pattern from '/img/instruments/videomancer/vidmusic/vidmusic_source4_pattern.png';
import vidmusic_source5_boy from '/img/instruments/videomancer/vidmusic/vidmusic_source5_boy.png';
import vidmusic_source6_wood from '/img/instruments/videomancer/vidmusic/vidmusic_source6_wood.png';
import vidmusic_hero_s1 from '/img/instruments/videomancer/vidmusic/vidmusic_hero_s1.png';
import vidmusic_hero_s2 from '/img/instruments/videomancer/vidmusic/vidmusic_hero_s2.png';
import vidmusic_hero_s3 from '/img/instruments/videomancer/vidmusic/vidmusic_hero_s3.png';
import vidmusic_hero_s4 from '/img/instruments/videomancer/vidmusic/vidmusic_hero_s4.png';
import vidmusic_hero_s5 from '/img/instruments/videomancer/vidmusic/vidmusic_hero_s5.png';
import vidmusic_hero_s6 from '/img/instruments/videomancer/vidmusic/vidmusic_hero_s6.png';
import vidmusic_ex1_s1 from '/img/instruments/videomancer/vidmusic/vidmusic_ex1_s1.png';
import vidmusic_ex1_s2 from '/img/instruments/videomancer/vidmusic/vidmusic_ex1_s2.png';
import vidmusic_ex1_s3 from '/img/instruments/videomancer/vidmusic/vidmusic_ex1_s3.png';
import vidmusic_ex1_s4 from '/img/instruments/videomancer/vidmusic/vidmusic_ex1_s4.png';
import vidmusic_ex1_s5 from '/img/instruments/videomancer/vidmusic/vidmusic_ex1_s5.png';
import vidmusic_ex1_s6 from '/img/instruments/videomancer/vidmusic/vidmusic_ex1_s6.png';
import vidmusic_ex2_s1 from '/img/instruments/videomancer/vidmusic/vidmusic_ex2_s1.png';
import vidmusic_ex2_s2 from '/img/instruments/videomancer/vidmusic/vidmusic_ex2_s2.png';
import vidmusic_ex2_s3 from '/img/instruments/videomancer/vidmusic/vidmusic_ex2_s3.png';
import vidmusic_ex2_s4 from '/img/instruments/videomancer/vidmusic/vidmusic_ex2_s4.png';
import vidmusic_ex2_s5 from '/img/instruments/videomancer/vidmusic/vidmusic_ex2_s5.png';
import vidmusic_ex2_s6 from '/img/instruments/videomancer/vidmusic/vidmusic_ex2_s6.png';
import vidmusic_ex3_s1 from '/img/instruments/videomancer/vidmusic/vidmusic_ex3_s1.png';
import vidmusic_ex3_s2 from '/img/instruments/videomancer/vidmusic/vidmusic_ex3_s2.png';
import vidmusic_ex3_s3 from '/img/instruments/videomancer/vidmusic/vidmusic_ex3_s3.png';
import vidmusic_ex3_s4 from '/img/instruments/videomancer/vidmusic/vidmusic_ex3_s4.png';
import vidmusic_ex3_s5 from '/img/instruments/videomancer/vidmusic/vidmusic_ex3_s5.png';
import vidmusic_ex3_s6 from '/img/instruments/videomancer/vidmusic/vidmusic_ex3_s6.png';
...
<BeforeAfterSlider
  sources={[
    { label: "Sunset", before: vidmusic_source1_sunset, after: vidmusic_hero_s1 },
    { label: "Ballerina", before: vidmusic_source2_ballerina, after: vidmusic_hero_s2 },
    { label: "Elephant", before: vidmusic_source3_elephant, after: vidmusic_hero_s3 },
    { label: "Pattern", before: vidmusic_source4_pattern, after: vidmusic_hero_s4 },
    { label: "Boy", before: vidmusic_source5_boy, after: vidmusic_hero_s5 },
    { label: "Wood", before: vidmusic_source6_wood, after: vidmusic_hero_s6 },
  ]}
/>
*Vidmusic rendering tiled Manhattan distance diamonds over a video source, colored by DDS hue cycling and modulated by IIR-averaged luminance.*

---

## Overview

The Atari Video Music (model C240) was released in 1977 — a consumer device that plugged into a television and translated stereo audio into geometric color patterns. Its signature visual was the diamond: sharp-edged shapes that pulsed and grew in response to the music's stereo channels, tiled across the screen in selectable repeating grids. Vidmusic recreates this aesthetic using video luminance as the driving signal instead of audio, generating Manhattan distance diamond fields whose sizes respond to the brightness of the upper and lower halves of the incoming image.

The name *Vidmusic* references the diamond-patterned costume of the commedia dell'arte character — a motley of repeating diamond shapes in contrasting colors. It is also apt because the program's output is inherently theatrical: bold geometric forms, cycling rainbow hues, and a repertoire of shape modes that the hardware can shuffle automatically.

At conservative settings with a single tile and solid fill, Vidmusic produces a single centered diamond that gently breathes with the source video's luminance. At extreme settings with maximum tiling, ring mode, fast hue cycling, and auto cycle enabled, the screen fills with a kaleidoscopic grid of pulsing diamond outlines in rapidly shifting colors — a faithful recreation of the Atari Video Music experience, driven by light instead of sound.
...
<img src={vidmusic_control_panel} alt="Videomancer front panel with Vidmusic loaded"/>
*Videomancer's front panel with Vidmusic active. Knobs 1–6 (top two rows of left cluster), Toggle switches 7–11 (bottom row of left cluster), Fader 12 (right side).*
...
Routes the unprocessed input signal directly to the output, bypassing all Vidmusic processing stages. The sync delay pipeline still aligns timing, so there is no glitch on transition. Use for instant A/B comparison between the raw input and the processed result.---
## Guided Exercises

These exercises progress from a single static diamond to a full tiled, color-cycling, auto-randomizing display. Each builds on the previous by engaging more of Vidmusic's shape and color controls.

### Exercise 1: Single Breathing Diamond

<BeforeAfterSlider
  sources={[
    { label: "Sunset", before: vidmusic_source1_sunset, after: vidmusic_ex1_s1 },
    { label: "Ballerina", before: vidmusic_source2_ballerina, after: vidmusic_ex1_s2 },
    { label: "Elephant", before: vidmusic_source3_elephant, after: vidmusic_ex1_s3 },
    { label: "Pattern", before: vidmusic_source4_pattern, after: vidmusic_ex1_s4 },
    { label: "Boy", before: vidmusic_source5_boy, after: vidmusic_ex1_s5 },
    { label: "Wood", before: vidmusic_source6_wood, after: vidmusic_ex1_s6 },
  ]}
/>
...
<BeforeAfterSlider
  sources={[
    { label: "Sunset", before: vidmusic_source1_sunset, after: vidmusic_ex2_s1 },
    { label: "Ballerina", before: vidmusic_source2_ballerina, after: vidmusic_ex2_s2 },
    { label: "Elephant", before: vidmusic_source3_elephant, after: vidmusic_ex2_s3 },
    { label: "Pattern", before: vidmusic_source4_pattern, after: vidmusic_ex2_s4 },
    { label: "Boy", before: vidmusic_source5_boy, after: vidmusic_ex2_s5 },
    { label: "Wood", before: vidmusic_source6_wood, after: vidmusic_ex2_s6 },
  ]}
/>
...
<BeforeAfterSlider
  sources={[
    { label: "Sunset", before: vidmusic_source1_sunset, after: vidmusic_ex3_s1 },
    { label: "Ballerina", before: vidmusic_source2_ballerina, after: vidmusic_ex3_s2 },
    { label: "Elephant", before: vidmusic_source3_elephant, after: vidmusic_ex3_s3 },
    { label: "Pattern", before: vidmusic_source4_pattern, after: vidmusic_ex3_s4 },
    { label: "Boy", before: vidmusic_source5_boy, after: vidmusic_ex3_s5 },
    { label: "Wood", before: vidmusic_source6_wood, after: vidmusic_ex3_s6 },
  ]}
/>
...
- **Feedback loops**: Routing Vidmusic's output back to its input creates a recursive feedback loop where the diamond shapes respond to their own brightness — producing self-reinforcing or oscillating diamond fields.
- **Bypass for A/B comparison**: Switch 11 instantly shows the unprocessed source for before/after evaluation.
- **Pair with a mixer**: Because Vidmusic generates bold geometric overlays, it works well as a layer in a multi-program composite — feed its output into another program's video background input.
