...
import yuv_amplifier_hero_s4 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_hero_s4.png';
import yuv_amplifier_hero_s5 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_hero_s5.png';
import yuv_amplifier_hero_s6 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_hero_s6.png';
import yuv_amplifier_ex1_s1 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex1_s1.png';
import yuv_amplifier_ex1_s2 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex1_s2.png';
import yuv_amplifier_ex1_s3 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex1_s3.png';
import yuv_amplifier_ex1_s4 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex1_s4.png';
import yuv_amplifier_ex1_s5 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex1_s5.png';
import yuv_amplifier_ex1_s6 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex1_s6.png';
import yuv_amplifier_ex2_s1 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex2_s1.png';
import yuv_amplifier_ex2_s2 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex2_s2.png';
import yuv_amplifier_ex2_s3 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex2_s3.png';
import yuv_amplifier_ex2_s4 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex2_s4.png';
import yuv_amplifier_ex2_s5 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex2_s5.png';
import yuv_amplifier_ex2_s6 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex2_s6.png';
import yuv_amplifier_ex3_s1 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex3_s1.png';
import yuv_amplifier_ex3_s2 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex3_s2.png';
import yuv_amplifier_ex3_s3 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex3_s3.png';
import yuv_amplifier_ex3_s4 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex3_s4.png';
import yuv_amplifier_ex3_s5 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex3_s5.png';
import yuv_amplifier_ex3_s6 from '/img/instruments/videomancer/yuv_amplifier/yuv_amplifier_ex3_s6.png';
...
1. **Defaults are transparent**: At noon on all knobs and fader fully up, the signal passes through bit-identical. YUV Amplifier is safe to leave in the chain as a calibration point.
...
<img src={yuv_amplifier_control_panel} alt="Videomancer front panel with YUV Amplifier loaded"/>
...
Controls the fade-to-color blend amount. At 100% (fully clockwise), the processed signal passes through at full strength. As the fader is lowered, the output interpolates toward a fixed target color — black or white for the Y channel (selected by the Fade Color toggle), and neutral chroma (512) for U and V regardless of the toggle setting. At 0%, the output is a flat monochrome field. This is distinct from a dry/wet mix: instead of crossfading between processed and original, the fade crossfades between processed and a fixed reference color. Use partial fade to soften extreme gain or offset settings by pulling the output back toward a neutral baseline.
