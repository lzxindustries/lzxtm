...
â”‚
â”œâ”€â”€ Timing Detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
â”‚   â”œâ”€ hsync/vsync falling-edge detect (manual, not video_timing_generator)
â”‚   â”œâ”€ X counter (pixel position within scanline)
â”‚   â””â”€ Y counter (scanline number within frame)
â”‚
â”œâ”€â”€ Hex Grid Computation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
â”‚   â”œâ”€ 1. Cell width         (cell_size upper bits + 4 â†’ range ~4-35 pixels)
â”‚   â”œâ”€ 2. Row offset         (odd rows shifted by half cell width)
â”‚   â”œâ”€ 3. Local position     (pixel X/Y modulo cell size, 6-bit wraparound)
â”‚   â””â”€ 4. Edge test          (local_x < line_width OR local_y < line_width)
â”‚
â”œâ”€â”€ Pixel Assignment â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
â”‚   â”œâ”€ Edge pixel:
â”‚   â”‚   â”œâ”€ Y = Brightness (pot 3)
â”‚   â”‚   â”œâ”€ U = Color (pot 4) if Color enabled, else 512
â”‚   â”‚   â””â”€ V = 1023 - Color if Color enabled, else 512
â”‚   â”‚
â”‚   â””â”€ Non-edge pixel:
â”‚       â”œâ”€ Fill On:  pass-through input Y/U/V
â”‚       â””â”€ Fill Off: Y=64, U=512, V=512 (near-black)
â”‚
â”œâ”€â”€ Interpolator Mix â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
â”‚   â””â”€ 3Ã— interpolator_u: crossfade between delayed input and processed output
â”‚
â”œâ”€â”€ Sync / Data Delay (8 clocks) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
â”‚   â””â”€ Shift registers for hsync, vsync, field, Y, U, V
â”‚
â””â”€â”€ Bypass Mux â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    â””â”€ Select processed (mix output) or delayed input
```

Honeycomb uses manual sync detection â€” falling-edge detection on hsync_n and vsync_n â€” rather than the shared `video_timing_generator` entity. This means the X and Y counters free-run from sync edges without active-video gating. The hex grid approximation works by adding half the cell width to the X coordinate on odd-numbered rows, creating the characteristic offset that makes rectangular cells read as hexagonal. The edge test operates on 6-bit local coordinates (modulo 64), and the line width is extracted from the upper 3 bits of the Line Width register, giving only 8 discrete thickness levels (0â€“7 pixels). Several registered parameters â€” Fill amount (Knob 5), Speed (Knob 6), Animate (Toggle 9), and 3D Effect (Toggle 10) â€” are wired to signals but have no effect on the output in the current implementation.
...
*Videomancer's front panel with Honeycomb active. Knobs 1â€“6 (top two rows of left cluster), Toggle switches 7â€“11 (bottom row of left cluster), Fader 12 (right side).*
...
Sets the hue of the grid lines when Color mode is enabled (Toggle 8 = RGB). The register value is assigned directly to the U channel of edge pixels, and its complement (1023 minus the value) is assigned to V. This creates a four-quadrant hue sweep through the YUV color plane as the knob travels from minimum to maximum. When Color mode is off (Mono), this control has no effect â€” edge pixels use neutral chroma (U=512, V=512), producing a monochrome grid.
...
*Basic Hex Grid â€” simulated result across source images.*
...
3. **Line width steps**: Starting with Cell Size at ~40%, sweep Line Width from 0% to 100%. Notice the stepped behavior â€” the line thickness changes in discrete jumps because only 3 bits of the register are used.
...
*Colored Overlay Grid â€” simulated result across source images.*
...
2. **Hue sweep**: Slowly turn the Color knob from 0% to 100%. Watch the grid lines cycle through cyan, green, magenta, and yellow â€” the four quadrants of the YUV color space.
...
*Bold Graphic Lattice â€” simulated result across source images.*
