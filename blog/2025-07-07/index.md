...
We have been working for years on more modular embedded systems for FPGA video processing, and that's the focus of the companion product we have named Videomancer.  Here are some photos leading up to where we are with it.
...
Now that we are so close, I plan to release my software simulator of Chromagnon so that you can play with it and start getting to know it, albeit in a limited fashion (my GPU cannot handle all the pixel crunching Chromagnon requires, at least not in full resolution!)

As the Summer moves on, we'd love to hear more from you about your current and ongoing video art projects.  E-mail us or hang out with us in social media and let us know your needs.

Hopefully you can make it to Video Sync in Portland, OR on Aug 15th-17th?  I will be giving a talk on my journey to developing the set of analog operators for video synthesis used in P-Series. 
