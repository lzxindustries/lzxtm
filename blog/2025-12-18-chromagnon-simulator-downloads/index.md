...
Hi everyone! As promised, I've made my Chromagnon Simulator available for download as portable applications for Windows.  This was a tool created for design reference during development of the hardware, so it is not very polished or useful beyond getting a preview of the instrument's functionality -- which I hope you will enjoy! 
...
{/* - **Linux**: [chromagnon-simulator-linux-portable.zip](/zip/apps/chromagnon-simulator-linux-portable.zip) */}
